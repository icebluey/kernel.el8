...
cd "${_tmp_dir}"
wget -q -c -t 9 -T 9 \
"https://github.com/icebluey/docker/releases/download/v2024-09-25/containerd-1.7.22-1_amd64.tar.xz"
wget -q -c -t 9 -T 9 \
"https://github.com/icebluey/docker/releases/download/v2024-09-25/docker-only-27.3.1-1_amd64.tar.xz"
